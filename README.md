...
4. Use /xtoysconnect \[Webhook ID\] to connect your XToys session, /xtoysdisconnect to disconnect. To see all connections, use /xtoyssockets to view all connections, and /bcxtoysinfo to see general info about the mod.
